...
function pp = scaleBoneFractionParameters(pp, scale)
    ...
    pp.avoidEdgeDistance = scaleWithOffset(pp.avoidEdgeDistance,  scale);
    pp.minSlice          = scaleWithOffset(pp.minSlice,           scale);
    pp.maxSlice          = scaleWithOffset(pp.maxSlice,           scale);
    pp.halfEdgeSize      = scaleWithOffset(pp.halfEdgeSize,       scale);
    pp.filterRadius      = scaleWithOffset(pp.filterRadius,       scale);
    pp.maxDistance       = scaleWithOffset(pp.maxDistance,        scale);
